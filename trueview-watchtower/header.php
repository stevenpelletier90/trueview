	...
	<div class="tv-header__inner">
		...
		<nav class="tv-nav">
			...
			<?php if ( is_front_page() ) : ?>
				...
				<a class="tv-nav__cta" href="<?php echo esc_url( $trueview_contact ); ?>"><span class="tv-nav__cta-full">Free Consultation</span><span class="tv-nav__cta-short">Contact</span></a>
			<?php else : ?>
